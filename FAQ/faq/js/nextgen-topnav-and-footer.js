...
function LoadMenu() {
    var commonTopNavbar = '<div id="top-navbar" class="navbar navbar-dark bg-dark navbar-expand-lg flex-column flex-md-row">\
    <span class="navbar-brand-special"><a href="index.html"><span class="ml-4 pl-2 fw-bold"></span> <span class="text-muted">|</span> FAQ</a></span>\
            ...
            <ul class="navbar-nav ml-auto">\
                <li class="nav-item active mr-4">\
                    <a class="nav-link" href="#">\
                        <!-- US Flag SVG -->\
<svg width="40px" height="24px" viewBox="0 0 512 300" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\
<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
    ...
    $('#common-top-navbar').append(commonTopNavbar);
        ...
        function LoadFooter() {
            var commonFooter = '<div class="card-footer text-light navbar-dark bg-dark ">\
            <div class="row">\
				<div class="col-sm-2">\
					<label class="text-light">CREATED BY:</label>\
					<label class="text-light">Dolly</label>\
				</div>\
				<div class="col-sm-2">\
					<label class="text-light">CREATED ON:</label>\
					<label class="text-light">08/20/2019</label>\
				</div>\
				<div class="col-sm-2">\
					<label class="text-light">LAST UPDATED BY:</label>\
					<label class="text-light">Dolly123</label>\
				</div>\
				<div class="col-sm-2">\
					<label class="text-light">LAST UPDATED ON:</label>\
					<label class="text-light">08/20/2019</label>\
				</div>\
				<div class="col-sm-2">\
					<label class="text-light">LOG DETAILS</label>\
				</div>\
			</div>\
    </div>';
